...
if query:
    ...
    with st.chat_message("assistant", avatar="🤖"):
        if err:
            ...
            # 100% hardcoded guarantee to show Surat, Gujarat, India cleanly
            if lang == "GUJARATI":
                ...
                reply = f"BC Tech Computer Education सूरत, गुजरात, भारत में स्थित है। विस्तृत पता और शाखा जानकारी के लिए आप इस आधिकारिक लिंक पर जा सकते हैं: {BRANCH_LINK}"
            else:
